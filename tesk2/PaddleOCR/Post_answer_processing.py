...
if __name__ == '__main__':
    ...
    parser.add_argument('--answer_path', type=str,
                        default=r'F:\JS\2021AIWIN\OCR\提交过程\tesk2\12_mobile_train_bank_500_0.99574\best_accuracy/answer.json')
    # bank地址库地址
    parser.add_argument('--bank_dict_path', type=str,
                        default=r'F:\JS\2021AIWIN\OCR\tesk2\submit\dataset\test/bank_dict.txt')
    # 新的answer地址
    parser.add_argument('--new_answer_path', type=str,
                        default=r'F:\JS\2021AIWIN\OCR\tesk2\submit/answer.json')
