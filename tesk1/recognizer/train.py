...
# 使用改造densenet模型
# from recognizer.models.densenet.crnn_model import CNN_CTC_MODLE
# 使用resnet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir',default='./temp/logdir/')
    # 设置训练数据集
    ...
    max_label_length = 50
    epochs = 60
    base_model, model = CNN_CTC_MODLE(initial_learning_rate=0.0007)
